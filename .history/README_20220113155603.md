...
It can be thought of like a 'Gaming' Server running on the Solana network. It makes it easy for game developers
to take their existing web2 games and adapt them to web3.
...
Games: card battles, turn-based X, breeding, land ownership, metaverse avatar customization
